...
from services.sheet_writer.constants import number_columns, text_columns, date_time_columns, date_columns, integer_columns, percent_columns
...
class GoogleSheetWriter:
    ...
    def write_data(self, data_to_write: list, headers: list, options: dict) -> int:
        ...
        """
        # Ép kiểu các trường number đang ở dạng string
        for row in data_to_write:
            for field in number_columns | integer_columns | percent_columns:
        ...
        for row in data_to_write:
            ...
            for h in final_headers:
                ...
                if h in number_columns | integer_columns | percent_columns and isinstance(val, (int, float)):
