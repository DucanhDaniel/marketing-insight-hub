...
class CurrencyExchangeService:
    ...
    def apply_exchange(self, data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        actual_account_id_col: Optional[str] = self._detect_account_id_column(sample_keys)
        ...
        # --- Xác định các cột tiền tệ cần convert (1 lần) ---
        monetary_cols = [col for col in sample_keys if _is_monetary_column(col)]
        currency_cols = [
            col for col in sample_keys
